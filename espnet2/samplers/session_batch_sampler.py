...
class SessionBatchSampler(AbsSampler):
    def __init__(
        self,
        batch_size: int,
        ...
        #     else:
        #         sessions[session_id]['audio'].append(key)
        #         sessions[session_id]['bins'] += utt2shapes[0][key][0] * utt2shapes[1][key][0]
        ...
        #     if len(batchlist[i]) < max_batch_length:
        #         div = max_batch_length // len(batchlist[i])
        #         mod = max_batch_length % len(batchlist[i])
        #         if div > 1:
        #             tmp = []
        #             for m in range(div):
        #                 tmp += batchlist[i]
        ...
        #             batchlist[i] = tmp
        #         else:
        #             batchlist[i] += batchlist[i][:(max_batch_length - len(batchlist[i]))]
